...
window.FLARE_GUIDANCE_PAYLOAD = {
  ...
  "issued": "2026-09-25T21:00:00Z",
  "valid_start": "2026-09-26T00:00:00Z",
  "valid_end": "2026-09-27T00:00:00Z",
  "quality": {
    "level": "research",
  ...
  "input": {
    ...
    "target_time": "2026-09-25T18:00:00Z",
    "latest_record": "2026-09-25T18:00:00Z",
    "oldest_retained_record": "2026-09-25T18:00:00Z",
    "raw_records": 1031,
    "retained_regions": 4,
    "mapping": {
      "skipped_multi_region_harps": 0,
      "skipped_unmapped_harps": 3,
      "expanded_rows": 10
    },
    "quality": {
      "input": 10,
    ...
    "swpc_full_disk": {
      ...
      "issued": "2026-09-25T22:00:00+00:00",
  ...
  "wxf_region_components": [
    ...
    },
    {
      ...
      "m1": 0.9916527656457144,
      "x1": 0.1775216452892769
    },
    {
      "component_id": "HARP14033",
      "m1": 2.730404734192619,
      "x1": 0.2525510463951078
    }
  ],
  "regions": [
    {
      ...
      "drivers": [
        "8 numbered active regions represented",
        "4 SHARP region values; 4 fallbacks",
      ...
      "members": {
        ...
        "swpc": {
          ...
          "issued": "2026-09-25T22:00:00+00:00",
          "valid_start": "2026-09-26T00:00:00+00:00",
          "valid_end": "2026-09-27T00:00:00+00:00"
        },
        "sidc": {
          "m1": 0.0,
          "x1": 0.0,
        ...
        "ccmc_assa": {
          ...
          "issued": "2026-09-26T00:00:00Z",
          "valid_start": "2026-09-26T00:00:00Z",
          "valid_end": "2026-09-26T12:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
        ...
        "ccmc_magpy_los": {
          ...
          "quality": "published-comparison",
          "issued": "2026-09-26T00:17:26Z",
          "valid_start": "2026-09-25T21:00:00Z",
          "valid_end": "2026-09-26T21:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
        ...
        "ccmc_magpy": {
          ...
          "quality": "published-comparison",
          "issued": "2026-09-26T01:04:32Z",
          "valid_start": "2026-09-25T22:00:00Z",
          "valid_end": "2026-09-26T22:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
        ...
        "ccmc_sps": {
          ...
          "quality": "published-comparison",
          "issued": "2026-09-25T17:00:00Z",
          "valid_start": "2026-09-25T17:00:00Z",
          "valid_end": "2026-09-26T17:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
    ...
    },
    {
      ...
      "quality": {
        "level": "research",
        "message": "SHARP NRT record age 3.0 h; shared 3-region HARP; |LON_FWT|=0.9°"
      },
      "members": {
        "sharpmag": {
          "m1": 1.0,
    ...
    },
    {
      ...
      "quality": {
        "level": "research",
        "message": "SHARP NRT record age 3.0 h; single-region HARP; |LON_FWT|=15.0°"
      },
      "members": {
        "sharpmag": {
          "m1": 2.7,
  ...
  "external_sources": {
    "generated_at": "2026-09-26T01:41:17Z",
    ...
    "ccmc_sidc": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=SIDC_Operator_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x_parameter": "X",
      "records": 4,
      "issued": "2026-09-25T12:30:03Z",
      "valid_start": "2026-09-25T12:30:00Z",
      "valid_end": "2026-09-26T12:30:00Z",
      "m1": 19.0,
      "x1": 1.0,
      "selected_record": {
        "start_window": "2026-09-25T12:30:00.0Z",
        "end_window": "2026-09-26T12:30:00.0Z",
        "issue_time": "2026-09-25T12:30:03.0Z",
        "C": "-1",
        "M": "-1",
        "CPlus": 0.83,
        "MPlus": 0.19,
    ...
    "ccmc_metoffice": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MO_TOT1_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_amos": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=AMOS_v1_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 0.0,
      "selected_record": {
        "start_window": "2026-09-26T00:00:00.0Z",
        "end_window": "2026-09-27T00:00:00.0Z",
        "issue_time": "2026-09-26T00:30:00.0Z",
        "C": 0.5046,
        "M": 0.057,
        "CPlus": "-1",
        "MPlus": "-1",
    ...
    "ccmc_ccmc_asap": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=ASAP_1_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_assa24": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=ASSA_24H_1_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "selected_record": {
        "start_window": "2026-09-26T00:00:00.0Z",
        "end_window": "2026-09-27T00:00:00.0Z",
        "issue_time": "2026-09-26T00:00:00.0Z",
        "C": 0.6751,
        "M": 0.1536,
        "CPlus": "-1",
        "MPlus": "-1",
    ...
    "ccmc_ccmc_assa": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=ASSA_1_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "selected_record": {
        "start_window": "2026-09-26T00:00:00.0Z",
        "end_window": "2026-09-26T12:00:00.0Z",
        "issue_time": "2026-09-26T00:00:00.0Z",
        "C": 0.43,
        "M": 0.08,
        "CPlus": "-1",
    ...
    "ccmc_ccmc_bom": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=BoM_flare1_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_mag4_fe": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MAG4_LOS_FEr_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_mag4": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MAG4_LOS_r_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_magpy_los": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MagPy-HMI-LOS_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 1.0,
      "selected_record": {
        "start_window": "2026-09-25T21:00:00.0Z",
        "end_window": "2026-09-26T21:00:00.0Z",
        "issue_time": "2026-09-26T00:17:26.0Z",
        "C": "-1",
        "M": "-1",
        "CPlus": "-1",
        "MPlus": 0.02,
    ...
    "ccmc_ccmc_magpy": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MagPy_SHARP_HMI_CEA_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 5.0,
      "selected_record": {
        "start_window": "2026-09-25T22:00:00.0Z",
        "end_window": "2026-09-26T22:00:00.0Z",
        "issue_time": "2026-09-26T01:04:32.0Z",
        "C": "-1",
        "M": "-1",
        "CPlus": "-1",
        "MPlus": 0.09,
    ...
    "ccmc_ccmc_sps": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=SPS_FULLDISK&time.min=2026-09-21T21%3A00%3A00.0&time.max=2026-09-26T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 1.0,
      "selected_record": {
        "start_window": "2026-09-25T17:00:00.0Z",
        "end_window": "2026-09-26T17:00:00.0Z",
        "issue_time": "2026-09-25T17:00:00.0Z",
        "C": 0.55,
        "M": 0.15,
        "CPlus": "-1",
        "MPlus": "-1",
