...
window.FLARE_GUIDANCE_PAYLOAD = {
  ...
  "input": {
    ...
    "target_time": "2026-09-02T18:00:00Z",
    "latest_record": "2026-09-02T18:00:00Z",
    "oldest_retained_record": "2026-09-02T18:00:00Z",
    "raw_records": 2353,
    "retained_regions": 1,
    "mapping": {
      "skipped_multi_region_harps": 2,
  ...
  "regions": [
    {
      ...
      "members": {
        ...
        "ccmc_assa": {
          ...
          "issued": "2026-09-03T00:00:00Z",
          "valid_start": "2026-09-03T00:00:00Z",
          "valid_end": "2026-09-03T12:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
        ...
        "ccmc_magpy_los": {
          ...
          "quality": "published-comparison",
          "issued": "2026-09-03T00:09:59Z",
          "valid_start": "2026-09-02T21:00:00Z",
          "valid_end": "2026-09-03T21:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
        ...
        "ccmc_sps": {
          ...
          "quality": "published-comparison",
          "issued": "2026-09-02T17:00:00Z",
          "valid_start": "2026-09-02T17:00:00Z",
          "valid_end": "2026-09-03T17:00:00Z",
          "note": "Probability reproduced from the NASA/CCMC Flare Scoreboard HAPI feed using the /data parameter schema.",
    ...
    },
    {
      ...
      "drivers": [
        ...
        "M1+: falling net current per polarity",
  ...
  "solar_monitor": {
    "source": "SolarMonitor",
    "source_url": "https://www.solarmonitor.org/forecast.php?date=20260903",
    "retrieved_at": "2026-09-03T00:19:14Z",
    "valid_start": "2026-09-03T00:00:00Z",
    "valid_end": "2026-09-04T00:00:00Z",
  ...
  "external_sources": {
    "generated_at": "2026-09-03T00:19:14Z",
    ...
    "ccmc_sidc": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=SIDC_Operator_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x_parameter": "X",
      "records": 4,
      "issued": "2026-09-02T12:30:03Z",
      "valid_start": "2026-09-02T12:30:00Z",
      "valid_end": "2026-09-03T12:30:00Z",
      "m1": 12.0,
      "x1": 1.0,
      "selected_record": {
        "start_window": "2026-09-02T12:30:00.0Z",
        "end_window": "2026-09-03T12:30:00.0Z",
        "issue_time": "2026-09-02T12:30:03.0Z",
        "C": "-1",
        "M": "-1",
        "CPlus": 0.82,
        "MPlus": 0.12,
    ...
    "ccmc_metoffice": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MO_TOT1_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_amos": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=AMOS_v1_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x_parameter": "X",
      "records": 4,
      "detail": "Forecast window does not meaningfully overlap target (2026-09-02T00:00:00Z to 2026-09-03T00:00:00Z)"
    },
    "ccmc_ccmc_asap": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=ASAP_1_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_assa24": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=ASSA_24H_1_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 0.0,
      "selected_record": {
        "start_window": "2026-09-03T00:00:00.0Z",
        "end_window": "2026-09-04T00:00:00.0Z",
        "issue_time": "2026-09-03T00:00:00.0Z",
        "C": 0.4224,
        "M": 0.0591,
        "CPlus": "-1",
        "MPlus": "-1",
    ...
    "ccmc_ccmc_assa": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=ASSA_1_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "selected_record": {
        "start_window": "2026-09-03T00:00:00.0Z",
        "end_window": "2026-09-03T12:00:00.0Z",
        "issue_time": "2026-09-03T00:00:00.0Z",
        "C": 0.24,
        "M": 0.03,
        "CPlus": "-1",
    ...
    "ccmc_ccmc_bom": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=BoM_flare1_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_mag4_fe": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MAG4_LOS_FEr_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_mag4": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MAG4_LOS_r_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
    ...
    "ccmc_ccmc_magpy_los": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MagPy-HMI-LOS_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 1.0,
      "selected_record": {
        "start_window": "2026-09-02T21:00:00.0Z",
        "end_window": "2026-09-03T21:00:00.0Z",
        "issue_time": "2026-09-03T00:09:59.0Z",
        "C": "-1",
        "M": "-1",
        "CPlus": "-1",
        "MPlus": 0.01,
    ...
    "ccmc_ccmc_magpy": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=MagPy_SHARP_HMI_CEA_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "selected_record": {
        "start_window": "2026-09-02T21:00:00.0Z",
        "end_window": "2026-09-03T21:00:00.0Z",
        "issue_time": "2026-09-03T00:04:01.0Z",
        "C": "-1",
        "M": "-1",
        "CPlus": "-1",
        "MPlus": 0.01,
    ...
    "ccmc_ccmc_sps": {
      ...
      "url": "https://iswa.ccmc.gsfc.nasa.gov/IswaSystemWebApp/flarescoreboard/hapi/data?id=SPS_FULLDISK&time.min=2026-08-29T21%3A00%3A00.0&time.max=2026-09-03T21%3A00%3A00.0&format=json&options=fields.all",
      "schema_source": "data",
      "parameter_names": [
        "start_window",
        "end_window",
      ...
      "x1": 1.0,
      "selected_record": {
        "start_window": "2026-09-02T17:00:00.0Z",
        "end_window": "2026-09-03T17:00:00.0Z",
        "issue_time": "2026-09-02T17:00:00.0Z",
        "C": 0.7,
        "M": 0.2,
        "CPlus": "-1",
        "MPlus": "-1",
